...
public class Circle {
    ...
    public Circle(float x,float y,float r,Color color, OrthographicCamera camera){
        this.x = x;
        this.y = y;
        this.r = r;
        this.color = color;
    ...
    protected Mesh createMesh() {
        Mesh mesh = new Mesh(true, 4, 6, new VertexAttribute(VertexAttributes.Usage.Position, 2, "a_position"));
